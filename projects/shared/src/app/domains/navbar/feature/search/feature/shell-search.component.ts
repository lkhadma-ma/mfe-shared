  ...
  template: `
    ...
    >
      ...
      <div class="p-3 border-b border-gray-100">
        ...
        <div class="space-y-1">
          <button
            class="w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-md flex items-center justify-between"
          >
      ...
      <div class="p-3 bg-gray-50 border-t border-gray-200 rounded-b-lg">
        <div class="flex items-center justify-between text-xs text-gray-500">
          ...
          <div class="flex items-center gap-1">
            <kbd
              class="px-2 py-1 text-xs font-semibold text-gray-600 bg-white border border-gray-300 rounded"
              >⌘K</kbd
            >
          </div>
        </div>
